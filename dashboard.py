...
# Footer
st.markdown("---")
st.caption("⚡ Proyecto Final Bootcamp TIC — Talento Tech 2026 | Jordan Rincón · Julián Mejía · Tulio Ruiz | Fuentes: XM Sinergox · NOAA · World Bank · Banco de la República")import streamlit as st
import pandas as pd
import numpy as np
import plotly.express as px
import plotly.graph_objects as go
